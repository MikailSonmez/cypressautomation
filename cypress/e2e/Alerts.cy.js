...
describe('Alerts', () => {
    ...
    it('Js alert', ()=>{
        ...
        cy.get("#result").should('have.text','Your successfully clicked an alert')


    })

    // 2) Javascript Confrim Alert: It will have some text with 'OK' and 'Cancel' buttons
    ...
    it('Js prompt alert', ()=>{
        ...
        cy.get("#reslt").should('have.text','Yout entered: welcome');
    ...
    it('Authenticated alert', ()=>{
        ...
        */
        // approach2
        cy.visit("https://admin:admin@the-internet.herokuapp.com/basic_aut")
        cy.get("div[class='example'] p").should('have.contain', "Congratulations");
